...
-(void)createBird {
    ...
    // BlueBird 형 bird 객체를 생성합니다.
    // 클래스화 시켜 이미 만든 CCSprite형 BlueBird 를 생성하는 것이기 때문에 위치만 입력을 합니다.
    // 예전의 CCSprite *bird를 클래스화 시켰기 때문에 코드 길이가 줄어졌고, 간소해졌습니다.
    ...
    // 만든 bird를 birdArray 에 집어넣은 후, Bird 클래스의 메소드 action을 호출하여 동작합니다.
